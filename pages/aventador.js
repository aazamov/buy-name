import classes from "../styles/card3.module.css";
      ...
      <div>
        ...
        <div className={classes.bmw}>
          ...
          <div className={classes["text"]}>
            <h1>Aventador</h1>
            <h4>
              The Aventador Competition model was introduced in August 2018
            </h4>
            <p>
              The Aventador Competition model was introduced in August 2018,
              with power increased to 617 hp at 6,000 rpm and torque remaining
