import classes from "../styles/card5.module.css";
      ...
      <div>
        ...
        <div className={classes.bmw}>
          ...
          <div className={classes["text"]}>
            <h1>Cullinan</h1>
            <h4>
              The Cullinan Competition model was introduced in August 2018
            </h4>
            <p>
              The Cullinan Competition model was introduced in August 2018, with
