import classes from "../styles/card4.module.css";
      ...
      <div>
        ...
        <div className={classes.bmw}>
          ...
          <div className={classes["text"]}>
            <h1>Bugatti</h1>
            <h4>The BugattiCompetition model was introduced in August 2018</h4>
            <p>
              The BugattiCompetition model was introduced in August 2018, with
